...
/**
 * How the plugin ties the Pricewatch view to the open Grand Exchange offer &ndash;
 * disabled ({@link #OFF}), a {@link #BUTTON} injected on the GE offer screen,
 * {@link #AUTO} opening the item in Pricewatch as soon as an offer screen appears,
