 ...
 * {@link PricewatchPlugin#OVERLAY_MAX}). Each item is drawn either in the dense compact
...
public class PricewatchScreenOverlay extends Overlay
{
	...
	private static final Color HIGH_COLOR = PricewatchColors.HIGH;
	private static final Color LOW_COLOR = PricewatchColors.LOW;
	private static final Color AVG_COLOR = PricewatchColors.AVG;
	private static final Color VOLUME_COLOR = new Color(190, 130, 220);
	private static final Color MUTED_COLOR = PricewatchColors.MUTED;
